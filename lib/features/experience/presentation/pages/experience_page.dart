      ...
      body: MaxWidth(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              'A pulse-line timeline: engineered progression, no visual noise.',
            ...
            Expanded(
              child: Stack(
                children: <Widget>[
                  BlocSelector<ExperienceCubit, ExperienceState, List<ExperienceEntry>>(
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(entry.dateRange, style: textTheme.labelMedium),
                const SizedBox(height: AppSpacing.x3),
                for (final h in entry.highlights) ...<Widget>[
                  Text('• $h', style: textTheme.bodyMedium),
                  const SizedBox(height: AppSpacing.x1),
                ],
              ],
            ),
